...
const Landing = () => {
  const features = [
    {
      ...
      title: "Smart Pantry Matching",
      description: "Input your ingredients and get personalized recipe suggestions instantly."
    },
    {
      icon: <Sparkles className="h-12 w-12 text-orange-500" />,
      title: "AI-Powered Recipe Rewriting",
      description: "Transform any recipe to be vegan, healthier, or faster to cook with AI."
    },
    {
      icon: <Trophy className="h-12 w-12 text-orange-500" />,
      title: "Gamified Cooking Progress",
      description: "Earn XP, unlock badges, and level up your cooking skills."
    },
    {
      icon: <Calendar className="h-12 w-12 text-orange-500" />,
      title: "Smart Meal Planning",
      description: "Plan your weekly meals with drag-and-drop simplicity."
    }
  ];
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: "Love the gamification! Earning badges makes cooking so much more fun and motivating.",
      rating: 5
    }
  ];
        ...
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              ...
              intelligent meal planning, and gamified progress tracking.
            </p>
          </div>
      ...
      <footer className="bg-[#242c3c] border-t border-gray-700 px-6 py-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-400">
            © 2024 ChefMate. All rights reserved. Made with ❤️ for home cooks everywhere.
          </p>
        </div>
      </footer>
    </div>
